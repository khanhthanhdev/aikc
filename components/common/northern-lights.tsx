...
export const NorthernLights = ({
  ...
  return (
    <div
      className={cx(
        "pointer-events-none fixed inset-x-0 top-0 z-50 flex h-32 flex-row items-center justify-center gap-4 bg-fd-background px-4 text-center font-semibold text-md opacity-50",
        className
      )}
      {...props}
    >
      <div
        className="direction-reverse absolute inset-0 -z-10 animate-movingBanner mix-blend-difference"
        style={
          {
      ...
      <div
        className="absolute inset-0 -z-10 animate-movingBanner mix-blend-color-dodge"
        style={
          {
