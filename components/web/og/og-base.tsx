...
/**
 * Inline SVG logo for OG images - Satori doesn't support importing React components
 * that use className/cx utilities
 */
const OgLogoSymbol = ({
  style,
  width,
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <OgLogoSymbol style={{ height: "2.5rem", width: "2.5rem" }} />
          <span>
